		...
		wp_localize_script(
			...
			array(
				...
				'i18n'        => array(
					...
					'contactSales'   => __( 'Contact Sales', 'wp-ai-chat-lab' ),
					'requestQuote'   => __( 'Request a Quote', 'wp-ai-chat-lab' ),
					'inquiryName'    => __( 'Name', 'wp-ai-chat-lab' ),
					'inquiryEmail'   => __( 'Email', 'wp-ai-chat-lab' ),
					'inquiryCompany' => __( 'Company', 'wp-ai-chat-lab' ),
					'inquiryPhone'   => __( 'Phone / WhatsApp', 'wp-ai-chat-lab' ),
					'inquiryMessage' => __( 'Message', 'wp-ai-chat-lab' ),
					'inquirySubmit'  => __( 'Submit Request', 'wp-ai-chat-lab' ),
					'inquiryCancel'  => __( 'Cancel', 'wp-ai-chat-lab' ),
					'inquiryRequired'=> __( 'Please complete the required fields.', 'wp-ai-chat-lab' ),
					'inquiryNameRequired' => __( 'Please enter your name.', 'wp-ai-chat-lab' ),
					'inquiryEmailRequired'=> __( 'Please enter your email address.', 'wp-ai-chat-lab' ),
					'inquiryEmailInvalid' => __( 'Please enter a valid email address.', 'wp-ai-chat-lab' ),
					'inquiryMessageRequired' => __( 'Please enter your message.', 'wp-ai-chat-lab' ),
					'inquiryError'   => __( 'The inquiry could not be submitted. Please try again.', 'wp-ai-chat-lab' ),
					'manualMessage'  => __( 'I would like to contact your sales team.', 'wp-ai-chat-lab' ),
					'quoteMessage'   => __( 'I would like to request a quote.', 'wp-ai-chat-lab' ),
				),
			)
		);
